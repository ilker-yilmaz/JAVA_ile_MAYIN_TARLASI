...
public class Beginner extends javax.swing.JFrame {
    ...
    String yeni_sayi = String.valueOf(sayi);
    ...
    private void buton_olustur(int width, int heigth, int mines) {
    ...
    private void initComponents() {
        ...
        jTextFieldMayınSayısı.setText("10");
