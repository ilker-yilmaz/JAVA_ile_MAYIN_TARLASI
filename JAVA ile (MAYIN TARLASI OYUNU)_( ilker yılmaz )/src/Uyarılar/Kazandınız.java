 ...
 * @author İLKER
 */
public class Kazandınız extends javax.swing.JFrame {

    /**
     * Creates new form Kazandınuz
     */
    public Kazandınız() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelKazandınız = new javax.swing.JLabel();
        jLabelGirisEkranınaDön = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setUndecorated(true);

        jPanel1.setBackground(new java.awt.Color(251, 255, 0));
        jPanel1.setForeground(new java.awt.Color(187, 11, 9));

        jLabelKazandınız.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabelKazandınız.setForeground(new java.awt.Color(0, 0, 0));
        jLabelKazandınız.setText("TEBRİKLER KAZANDINIZ...");

        jLabelGirisEkranınaDön.setForeground(new java.awt.Color(51, 51, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kazandınız.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kazandınız().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelKazandınız;
